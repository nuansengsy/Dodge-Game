...
namespace MK.Glow
{
    ...
    internal static class PipelineExtensions
    {
        ...
        internal static void Draw(this CommandBuffer cmd, List<RenderTarget> destinations, Material material, int pass)
        {
        ...
        internal static void UpdateMipRenderContext(this UnityEngine.Camera camera, RenderContext[] renderContexts, RenderDimension rawDimension, int levels, RenderTextureFormat format, int depthBufferBits)
        {
